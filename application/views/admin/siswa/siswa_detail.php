            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body box-profile">
                        ...
                        <a href="<?php echo base_url() . 'admin/pengguna/siswa_edit/' . $kode_siswa; ?>" class="btn btn-success btn-block"><b><i class="fa fa-edit"> </i> Ubah Data</b></a>

                        <a href="<?php echo base_url() . 'admin/pengguna/siswa/'; ?>" class="btn btn-default btn-block"><b><i class="fa fa-arrow-left"> </i> Kembali</b></a>
                    </div>
                </div>
                <!-- /.box -->
            </div>
