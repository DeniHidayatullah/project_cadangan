...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="<?php echo base_url(); ?>diganti ya">
          <i class="fa fa-balance-scale"></i> <span>Bahan & Tugas</span>
        </a>
      </li>
      <li>
      ...
      <li class="<?php if ($this->uri->segment(1) == 'nilai') echo 'active'; ?> treeview <?php if ($this->uri->segment(1) == 'nilai') echo 'menu-open'; ?>">
        ...
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>diganti ya"><i class="fa fa-angle-double-right"></i> Cetak Raport UTS</a></li>
          <li><a href="<?php echo base_url(); ?>diganti ya"><i class="fa fa-angle-double-right"></i> Cetak Raport</a></li>
        </ul>
      </li>
