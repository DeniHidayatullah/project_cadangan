        ...
        <div class='col-md-12'>
            <div class='box box-info'>
                <div class='box-header with-border'>
                    <h3 class='box-title'>Data Nilai Sikap Siswa</b></h3>
                </div>
                        ...
                        <div id='myTabContent' class='tab-content'>
                            ...
                            <div role='tabpanel' class='tab-pane fade active in' id='spiritual' aria-labelledby='spiritual-tab'>
                                ...
                                <div class='box-footer'>
                                    <a href="<?php echo base_url('guru/data_nilai_raport/data_nilai_raport'); ?>"><button type='button' class='btn btn-success'>Simpan</button></a>
                                    <a href="<?php echo base_url('guru/data_nilai_raport/data_nilai_raport'); ?>"><button type='button' class='btn btn-danger'>Kembali</button></a>
                                </div>
                                </form>
                            </div>
